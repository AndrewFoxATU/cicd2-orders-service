...
# from revision 0001 (via create_all) but no alembic_version table — stamp
# those at 0001 so upgrade only applies newer revisions instead of failing
# on CREATE TABLE.
